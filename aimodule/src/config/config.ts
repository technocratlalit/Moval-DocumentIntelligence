...
const {
  ...
  CLAIM_GEMINI_FALLBACK,
  CLAIM_ALIAS_FUZZY_THRESHOLD,
} = process.env;
...
export const _config = {
  ...
  MISTRAL_OCR_EXTRACT_HEADER: parseEnvBool(MISTRAL_OCR_EXTRACT_HEADER, true),
  MISTRAL_OCR_EXTRACT_FOOTER: parseEnvBool(MISTRAL_OCR_EXTRACT_FOOTER, true),
  ...
  // Claim Pass 2 (Gemini text mapping fallback)
  CLAIM_AI_MODEL: parseEnvOptional(CLAIM_AI_MODEL) ?? resolvedAiModelLite,
  CLAIM_MAX_OUTPUT_TOKENS: parseEnvInt(CLAIM_MAX_OUTPUT_TOKENS, 4096),
  CLAIM_MAX_GEMINI_RETRIES: parseEnvInt(CLAIM_MAX_GEMINI_RETRIES, 1),
  CLAIM_GEMINI_FALLBACK: parseEnvBool(CLAIM_GEMINI_FALLBACK, true),
  CLAIM_ALIAS_FUZZY_THRESHOLD: parseEnvFloat(CLAIM_ALIAS_FUZZY_THRESHOLD, 0.85),
